...
// gitignoreService implements model.GitignoreService

// gitignoreService implements model.GitignoreService using go-git's gitignore matcher.
...
func NewGitignoreService(workspaceRoot string, fs model.FileSystem) (model.GitignoreService, error) {
