...
func EnsureDockerReady(ctx context.Context, runner model.CommandExecutor, config model.DockerConfig, retryAttempts int, retryIntervalMs int) error {
...
func CollectComposeContainers(ctx context.Context, runner model.CommandExecutor, dir string) ([]string, error) {
